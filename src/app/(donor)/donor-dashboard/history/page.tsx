...
import { 
  ...
  MoreHorizontal, DownloadCloud, ExternalLink,
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 text-left">
        <div>
          <h1 className="text-3xl font-bold text-zinc-900 tracking-tight">Giving History</h1>
          <p className="text-zinc-500 mt-2 text-lg">Your complete record of impact and tax-deductible contributions.</p>
        </div>
        <div className="flex flex-wrap gap-3">
           ...
           <Button className="bg-zinc-900 hover:bg-zinc-800 text-white shadow-md font-semibold">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-zinc-950 text-white border-none shadow-2xl overflow-hidden relative group">
               ...
               <CardContent className="p-8 relative z-10 text-left">
                  <div className="flex items-center justify-between mb-6">
                     <span className="text-xs font-bold uppercase tracking-wider text-zinc-400 bg-white/5 px-2 py-1 rounded">Total Giving {yearFilter}</span>
            ...
            <div className="grid grid-cols-2 gap-4">
                <Card className="bg-white border-zinc-200 shadow-sm hover:shadow-md transition-shadow">
                    <CardContent className="p-5 flex flex-col items-center text-center justify-center h-full">
                        ...
                        <p className="text-xs font-semibold text-zinc-500 uppercase tracking-wide mt-1">Receipts</p>
                    </CardContent>
                </Card>
                <Card className="bg-white border-zinc-200 shadow-sm hover:shadow-md transition-shadow">
                    <CardContent className="p-5 flex flex-col items-center text-center justify-center h-full">
                        ...
                        <p className="text-xs font-semibold text-zinc-500 uppercase tracking-wide mt-1">Total Gifts</p>
                    </CardContent>
                </Card>
            </div>
         </div>
         ...
         <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
               <div className="relative flex-1">
                  ...
                  <Input 
                     ...
                     className="pl-9 bg-white border-zinc-200 h-10 shadow-sm focus:ring-2 focus:ring-zinc-100"
                     value={searchTerm}
               ...
               <div className="flex gap-2 overflow-x-auto pb-1 sm:pb-0">
                  <DropdownMenu>
                     <DropdownMenuTrigger asChild>
                        <Button variant="outline" className="h-10 border-zinc-200 bg-white text-zinc-700 shadow-sm">
            ...
            {/* List View */}
            <Card className="border-zinc-200 shadow-sm overflow-hidden flex-1 flex flex-col text-left">
               
               {/* Desktop Table Header */}
               <div className="hidden md:grid grid-cols-12 gap-4 p-4 bg-zinc-50 border-b border-zinc-200 text-xs font-semibold text-zinc-500 uppercase tracking-wider">
                     ...
                     >
                        {filteredTransactions.map((tx) => (
                           <motion.div 
                              ...
                              className="group bg-white hover:bg-zinc-50 transition-colors p-4 md:p-0 md:h-16 md:grid md:grid-cols-12 md:gap-4 md:items-center relative"
                           >
                              {/* Mobile Layout */}
                              <div className="flex justify-between md:hidden mb-2">
                                 <span className="text-xs text-zinc-500 font-medium">{new Date(tx.date).toLocaleDateString()}</span>
                              ...
                              {/* Date (Desktop) */}
                              <div className="hidden md:block col-span-2 px-4 text-sm font-medium text-zinc-600">
                              ...
                              <div className="md:col-span-4 md:px-0 mb-2 md:mb-0">
                                 <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                       <div className="text-sm font-bold text-zinc-900 leading-none mb-1">{tx.recipient}</div>
                                       <div className="text-xs text-zinc-500 flex items-center gap-1.5">
                                          <span className="bg-zinc-100 px-1.5 py-0.5 rounded text-[10px] uppercase font-bold tracking-wide">{tx.type}</span>
                              ...
                              <div className="flex justify-between items-center md:block md:col-span-2 md:px-0">
                                 <span className="text-sm text-zinc-500 md:hidden">Amount</span>
                              ...
                              <div className="md:col-span-2 flex justify-end md:px-4 mt-3 md:mt-0 border-t md:border-none pt-3 md:pt-0 gap-2">
                                 {tx.status === 'Succeeded' && (
                                    <Button variant="ghost" size="sm" className="h-8 text-xs font-medium text-zinc-500 hover:text-zinc-900 hover:bg-zinc-200/50">
