    ...
    <div className="space-y-2">
      ...
      <div className="relative group">
        <Input 
          ...
          value={value} 
          onChange={onChange}
          className="pr-10 bg-zinc-50 border-zinc-200 focus:bg-white focus:ring-2 focus:ring-blue-100 transition-all duration-200" 
...
const ProfileTab = () => {
  ...
  return (
    ...
    >
      {/* Avatar Section */}
      <Card className="border-zinc-200 shadow-sm overflow-hidden text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="relative group">
              <Avatar className="h-20 w-20 border-4 border-white shadow-md ring-1 ring-zinc-100">
                ...
                <AvatarFallback className="bg-zinc-900 text-white text-2xl">JD</AvatarFallback>
              </Avatar>
            ...
            <div className="flex flex-col gap-3 text-center sm:text-left">
              <div>
                <h4 className="font-medium text-zinc-900">Profile Photo</h4>
                <p className="text-xs text-zinc-500 mt-1">JPG, GIF or PNG. Max 2MB.</p>
              </div>
              <div className="flex gap-3 justify-center sm:justify-start">
                <Button variant="outline" size="sm" className="bg-white h-8 text-xs border-zinc-200 shadow-sm hover:bg-zinc-50">
                  Upload New
                </Button>
      ...
      {/* Personal Info Form */}
      <Card className="border-zinc-200 shadow-sm text-left">
        <CardHeader className="bg-zinc-50/50 border-b border-zinc-100 pb-4">
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-2">
              ...
              <Input id="firstName" defaultValue="John" className="bg-white border-zinc-200 focus:border-blue-300 transition-all h-10" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="lastName" className="text-zinc-700">Last Name</Label>
              <Input id="lastName" defaultValue="Doe" className="bg-white border-zinc-200 focus:border-blue-300 transition-all h-10" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" defaultValue="john.doe@example.com" className="pl-9 bg-white border-zinc-200 focus:border-blue-300 transition-all h-10" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="phone" type="tel" defaultValue="+1 (555) 123-4567" className="pl-9 bg-white border-zinc-200 focus:border-blue-300 transition-all h-10" />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 pt-2">
            <div className="space-y-2">
              <Label htmlFor="address" className="text-zinc-700">Street Address</Label>
              <div className="relative">
                <MapPin className="absolute left-3 top-3 h-4 w-4 text-zinc-400" />
                <Input id="address" defaultValue="123 Mission Way" className="pl-9 bg-white border-zinc-200 focus:border-blue-300 transition-all h-10" />
              </div>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
              <div className="space-y-2">
                <Label htmlFor="city" className="text-zinc-700">City</Label>
                <Input id="city" defaultValue="San Francisco" className="bg-white border-zinc-200 h-10" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="state" className="text-zinc-700">State</Label>
                <Input id="state" defaultValue="CA" className="bg-white border-zinc-200 h-10" />
              </div>
              <div className="space-y-2 col-span-2 md:col-span-1">
                <Label htmlFor="zip" className="text-zinc-700">Postal Code</Label>
                <Input id="zip" defaultValue="94105" className="bg-white border-zinc-200 h-10" />
              </div>
            </div>
          </div>
        ...
        <CardFooter className="bg-zinc-50/50 border-t border-zinc-100 p-4 flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-zinc-400 hidden sm:block">Last updated: 3 days ago</p>
          <div className="flex gap-3 w-full sm:w-auto">
            <Button variant="ghost" className="text-zinc-500 hover:text-zinc-900 w-full sm:w-auto h-9">Cancel</Button>
            <Button onClick={handleSave} disabled={loading} className={cn("min-w-[120px] transition-all w-full sm:w-auto h-9", success ? "bg-emerald-600 hover:bg-emerald-700" : "bg-zinc-900 hover:bg-zinc-800")}>
...
const NotificationsTab = () => {
  ...
  return (
    <Card className="border-zinc-200 shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500 text-left">
      <CardHeader className="bg-zinc-50/50 border-b border-zinc-100 pb-4">
                ...
                <div key={idx} className="p-6 md:p-8 hover:bg-zinc-50/30 transition-colors">
                    <div className="flex flex-col md:flex-row md:gap-12 gap-6">
                        <div className="md:w-48 shrink-0 flex items-start gap-3">
                            ...
                            <h3 className="text-sm font-bold text-zinc-900 mt-1.5">{category.title}</h3>
                        </div>
                                ...
                                <div key={item.key} className="flex items-start justify-between gap-4">
                                    <div className="space-y-0.5">
                                        <div className="flex items-center gap-2">
                                            <Label htmlFor={item.key} className="text-sm font-medium text-zinc-900 cursor-pointer">{item.label}</Label>
                                            {item.recommended && (
      ...
      <CardFooter className="bg-zinc-50/50 border-t border-zinc-100 p-4 flex flex-col sm:flex-row justify-between items-center gap-4">
        <p className="text-xs text-zinc-400 italic flex items-center gap-2 text-center sm:text-left">
      ...
      <Card className="border-zinc-200 shadow-sm overflow-hidden">
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex justify-between">
                    ...
                    <span className="text-[10px] font-bold text-zinc-600">{strengthScore >= 4 ? "Strong" : strengthScore >= 2 ? "Medium" : "Weak"}</span>
                </div>
              </div>
        ...
        <CardFooter className="bg-zinc-50/50 border-t border-zinc-100 p-4 flex justify-end">
          <Button 
            ...
            className={cn("min-w-[140px] h-9 shadow-sm transition-all w-full sm:w-auto", success ? "bg-emerald-600 hover:bg-emerald-700" : "bg-zinc-900 hover:bg-zinc-800")}
          >
            {loading ? <Loader2 className="mr-2 h-3 w-3 animate-spin" /> : success ? <Check className="mr-2 h-3 w-3" /> : null}
          ...
          <CardContent className="space-y-4 flex-1">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-bold text-zinc-900">Macbook Pro</p>
                <p className="text-[10px] text-zinc-500">San Francisco • Active now</p>
              </div>
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500 pb-20 pt-4">
      ...
      <div className="space-y-1.5 px-1 text-left">
        ...
        <p className="text-zinc-500 text-lg">Manage your profile and preferences.</p>
      </div>
          ...
          <ScrollArea className="w-full whitespace-nowrap lg:whitespace-normal">
            <div className="flex lg:flex-col gap-2 p-1 bg-white rounded-xl border border-zinc-200 shadow-sm">
              {TABS.map((tab) => (
                ...
                >
                  <tab.icon className={cn("h-4 w-4 relative z-10", activeTab === tab.id ? "text-zinc-300" : "text-zinc-400 group-hover:text-zinc-600")} />
